...
class MCTSPlayer(BasePlayer):
    def __init__(self):
        ...
        self.modelfile = r'C:/work/gctshogi/model/model.h5'
        # self.modelfile = r'C:/work/gctshogi/model/1554220378'
        self.model = None # モデル
    ...
    def position(self, moves):
        ...
        if moves[0] == 'startpos':
            ...
            for move in moves[2:]:
                ...
                # self.do_move(move)
                self.do_move(shogi.Move.from_usi(move))
    ...
    def eval_node(self):
        ...
        # logits = np.array(predictions['policy_head'].data, dtype=np.float32)
        # values = np.array(predictions['value_head'].data, dtype=np.float32)
    ...
    def queuing_node(self, board, moves, repetitions, node):
        ...
        # self.features.append(make_input_features_from_board(board))
