...
from gctshogi.agent.selfplay_agent import SelfPlayAgentGroup
from train import compile, train
# from gctshogi import database
...
def run(test_kifu_list, model_path, agents, checkpoint, playouts, limit_cycles, batchsize, lr, steps, test_steps, window_size, weight_decay):
    ...
    positions_train = []
    agent_group = SelfPlayAgentGroup(model, positions_train, agents, checkpoint, playouts)
    ...
    while True:
        ...
        train(positions_train, positions_test, model, batchsize, steps, test_steps, window_size)
